...
if menu == "Employee Directory":
        ...
        with st.expander("📝 New Employee Form", expanded=True):
            with st.form("add_employee_form"):
                ...
                with col1:
                    ...
                    join_date = st.date_input("Join Date", min_value=date(2000,1,1), max_value=date.today())
                ...
                with col2:
                    ...
                    allowance_monthly = st.number_input("Allowance Monthly", min_value=0)
    ...
    selected_id = st.selectbox("Select Employee", df["employee_id"].astype(str))
        ...
        with st.form("edit_employee_form"):
            ...
            if update:
                ...
                updated_row = [
                    ...
                    selected_emp["bank_account_number"],
...
if menu == "Payroll":
    ...
    if not df_log.empty and selected_month in df_log["month"].values:
        locked = True
        st.success("✅ Payroll already finalized")
    ...
    payroll_df = pd.DataFrame(payroll, columns=[
        "Employee ID","Name","Department","Present Days",
        "Daily Basic","Daily Transport","Allowance",
        "Overtime","Bonus"
    ])
